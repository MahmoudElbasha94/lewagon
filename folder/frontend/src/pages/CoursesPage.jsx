            ...
            <ul className="list-unstyled">
              {categories.map(category => (
                <li key={category} className="mb-2">
                  <button
                    className={`btn w-100 text-start ${selectedCategory === category ? 'btn-danger text-white' : 'btn-outline-danger'}`}
            ...
            <ul className="list-unstyled">
              {levels.map(level => (
                <li key={level} className="mb-2">
                  <button
                    className={`btn w-100 text-start ${selectedLevel === level ? 'btn-danger text-white' : 'btn-outline-danger'}`}
