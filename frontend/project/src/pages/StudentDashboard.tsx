...
const StudentDashboard: React.FC = () => {
  ...
  const enrolledCourses = [
    ...
    },
    {
      ...
      progress: 45,
      nextLesson: "Working with Databases",
  ...
  const achievements = [
    { id: 1, title: "Completed 5 Courses", icon: Award, date: "2024-03-15" },
    { id: 2, title: "Python Certificate", icon: GraduationCap, date: "2024-03-10" },
    { id: 3, title: "100 Hours of Learning", icon: Clock, date: "2024-03-05" },
  ];
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-red-50 rounded-xl p-4">
                  ...
                  <p className="mt-2 text-gray-600">Enrolled Courses</p>
                </div>
                <div className="bg-blue-50 rounded-xl p-4">
                  ...
                  <p className="mt-2 text-gray-600">Learning Hours</p>
                </div>
                <div className="bg-green-50 rounded-xl p-4">
                  ...
                  <p className="mt-2 text-gray-600">Certificates</p>
                </div>
              </div>
            </motion.div>
                ...
                {enrolledCourses.map((course) => (
                  <div key={course.id} className="bg-gray-50 rounded-xl p-4">
                    ...
                    <div className="flex items-center justify-between text-sm">
                      <span className="text-gray-600">Next Lesson: {course.nextLesson}</span>
